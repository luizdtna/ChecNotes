...
if ($SendCadImg) {
    ...
    if ($insert_msg->execute()) {
        ...
        if(move_uploaded_file($_FILES['imagem']['tmp_name'], $diretorio.$nome_imagem)){
            $_SESSION['msg'] = "<p style='color:green;'>Arquivos enviados com sucesso</p>";
            header("Location: notas.php");
        }else{
            $_SESSION['msg'] = "<p><span style='color:green;'> </span><span style='color:red;'>Escolher arquivo</span></p>";
            header("Location: notas.php");
        }        
    } else {
