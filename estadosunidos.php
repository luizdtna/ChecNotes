...
$query = "SELECT id, username, snome, email, universidade, curso, pais, anos   FROM registo WHERE pais='Estados Unidos'  "  ;
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <center><h1>Lista e Aproveitamentos dos Estudantes no Estados Unidos</h1></center><br><br>
  <div class="container">
