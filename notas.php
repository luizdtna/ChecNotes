...
<div class="wrapper">
          ...
          <!-- Add icons to the links using the .nav-icon class
           ...
           <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="dados.php" class="nav-link">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
     ...
     <center><h2>Meus Aproveitamentos</h2></center><br><br>
...
<?php
   ...
   <button type="submit" class="btn btn-flat btn-primary" name="submit"> Enviar</button>
   </form>-->
