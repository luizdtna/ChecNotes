...
<div class="wrapper">
          ...
          <!-- Add icons to the links using the .nav-icon class
           ...
           <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="estadosunidos.php" class="nav-link">
                 <p>Estados Unidos</p>
                </a>
              </li>
              <li class="nav-item">
  ...
  <div class="content-wrapper">
    ...
    <center><h1>Notas dos estudantes</h1></center><br><br>
...
$outrofiles = scandir('img');
echo $outrofiles[3]."<br>";
#print_r($outrofiles);
$files2 = scandir('img/'.$outrofiles[2]);
print_r($files2);
...
for ($a = 2; $a < count($files); $a++) {
  ...
  <p>
  <a href=""></a>
  <!--<a download = "<?php echo 'img/bg-img/gallery1.jpg' ?> <?php echo "teste" ?></a>-->
  <a download = "<?php echo 'gallery1.jpg' ?>" href="img/bg-img"> <?php echo $files[$a] ?></a>
</p>
</td>
</tr>
</table></center>
