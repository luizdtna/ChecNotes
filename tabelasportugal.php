...
include ("server.php");
session_start();
$query = "SELECT id, username, snome, email, universidade, curso, pais, anos   FROM registo WHERE pais='Portugal' order by username ASC "  ;
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
   ...
   <center><h1>Lista e Aproveitamentos dos Estudantes em Portugal</h1></center><br><br>
  <div class="container">
<center>
